...
func CheckError(err error) {
	...
	if e, ok := err.(Error); ok {
		...
		glog.Error("If the problem persists consult the docs at https://github.com/s2iservice/tree/master/docs. " +
			"Eventually reach us on freenode #openshift or file an issue at https://github.com/s2iservice/issues " +
